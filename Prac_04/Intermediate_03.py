...
lowercase_full_names = [fullname.lower() for fullname in full_names]
print(lowercase_full_names)

almost_numbers = ['0', '10', '21', '3', '-7', '88', '9']
# TODO: use a list comprehension to create a list of integers from the above list of strings
numbers = [int(i) for i in almost_numbers if int(i) > 0]
print(numbers)
...
numbers = [int(i) for i in almost_numbers if int(i) > 9]
print(numbers)